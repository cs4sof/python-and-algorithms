...
# Exercises - Intro to Data Types

# Code the following and add a comment for each line of code
# Upload the file to your Github account in a repository called
# Python - data types

'''
Exercise #1
Suppose you have $100, which you can invest with a 10% return each year.
After one year, it's 100×1.1=110100×1.1=110 dollars, and after two years
it's 100×1.1×1.1=121100×1.1×1.1=121.
